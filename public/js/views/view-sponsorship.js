(function () {
  ...
  async function mount(outlet) {
    ...
    try {
      if (!cachedHtml) {
        var resp = await fetch('/pages/sponsorship/sponsor.html', { credentials: 'include' });
      ...
      outlet.innerHTML = '<div class="spa-error"><i class="fa-regular fa-circle-xmark"></i><p>Could not load sponsorship.</p></div>';
    }
  }
  ...
  if (window.SpaRouter) {
    window.SpaRouter.register('sponsorship', { mount: mount, unmount: unmount });
  }
})();
